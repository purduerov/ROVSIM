...
classdef thrustMapper %[v1.0]
    ...
    methods
        ...
        %% MAPPING FUNCTIONS
        function thrustList = mapForce(self,F_des)
            thrustList = self.map_F2T*F_des;
        end
        
        function thrustList = mapMoment(self,M_des)
            thrustList = self.map_M2T*M_des;
        end
        
        function thrustList = mapBoth(self,F_des,M_des)
